        ...
        <div className="screen-scrim menu-scrim">
          <section className={`menu-panel menu-panel--${menuStep}`}>
            {menuStep === "welcome" ? <>
              ...
              <footer className="landing-footnote">Mỗi lượt chơi đạt Top 20 được lưu thành một dòng riêng, kể cả khi trùng tên.</footer>
            </> : <>
