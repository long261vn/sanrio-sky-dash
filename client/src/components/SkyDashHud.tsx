...
function RecordRainbowBurst() {
  return <div className="record-rainbow-burst" role="img" aria-label="Hiệu ứng cầu vồng chúc mừng kỷ lục mới"><span className="record-rainbow record-rainbow--pink" /><span className="record-rainbow record-rainbow--yellow" /><span className="record-rainbow record-rainbow--mint" /><i className="record-sparkle record-sparkle--one">✦</i><i className="record-sparkle record-sparkle--two">✦</i><i className="record-sparkle record-sparkle--three">✦</i></div>;
}
